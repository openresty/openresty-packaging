...
openresty-openssl111-asan-download:
	...
	rm -rf openresty-openssl111-asan_$(SSL111_VER)
	mkdir -p openresty-openssl111-asan_$(SSL111_VER)
	tar -xf openssl-$(SSL111_VER).tar.gz --strip-components=1 -C openresty-openssl111-asan_$(SSL111_VER)
	tar -czf openresty-openssl111-asan_$(SSL111_VER).orig.tar.gz openresty-openssl111-asan_$(SSL111_VER)
...
openresty-openssl111-asan-build: openresty-openssl111-asan-clean openresty-openssl111-asan-download
	...
	tar xf openresty-openssl111-asan_$(SSL111_VER).orig.tar.gz --strip-components=1 -C openresty-openssl111-asan
