...
openresty-utils-build: openresty-utils-clean openresty-utils-download
	sudo apt-get -y -q install ccache gcc make $(deb_toolchain_pkgs) openresty-pcre-dev
	sudo apt-get -y -q --only-upgrade install ccache gcc make $(deb_toolchain_pkgs) openresty-pcre-dev
