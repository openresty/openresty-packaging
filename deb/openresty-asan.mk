...
openresty-asan-build: openresty-asan-clean openresty-asan-download
	sudo apt-get -y -q install ccache make perl systemtap-sdt-dev gcc valgrind openresty-zlib-asan-dev openresty-openssl111-asan-dev openresty-pcre2-asan-dev
	sudo apt-get -y -q install --only-upgrade ccache make perl systemtap-sdt-dev gcc valgrind openresty-zlib-asan-dev openresty-openssl111-asan-dev openresty-pcre2-asan-dev
