...
lua-kafka-nginx-module-1.21.4-download:
	wget -nH --cut-dirs=100 --mirror 'https://openresty.org/download/openresty-1.21.4.2rc1.tar.gz'
	...
	tar -xf openresty-1.21.4.2rc1.tar.gz -C lua-kafka-nginx-module-1.21.4_$(LUA_KAFKA_NGINX_MODULE_VER)
