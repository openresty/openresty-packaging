...
OPENRESTY_TCMALLOC_VER := 2.10

.PHONY: openresty-tcmalloc-download
openresty-tcmalloc-download:
	LANG=C LC_ALL='C.UTF-8' wget -nH --cut-dirs=100 --mirror 'https://github.com/gperftools/gperftools/releases/download/gperftools-$(OPENRESTY_TCMALLOC_VER)/gperftools-$(OPENRESTY_TCMALLOC_VER).tar.gz'
