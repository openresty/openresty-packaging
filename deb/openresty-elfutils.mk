...
OPENRESTY_ELFUTILS_VER := 0.177.11
...
openresty-elfutils-build: openresty-elfutils-clean openresty-elfutils-download
	...
	sudo apt-get -y -q --only-upgrade install gcc libc6 bison flex m4 gettext zlib1g-dev libbz2-dev liblzma-dev g++ autoconf openresty-yajl-dev gawk sed
