...
OPENRESTY_SAAS_PCRE2_VER = 10.45
...
openresty-pcre2-download:
	...
	tar -czf openresty-pcre2_$(OPENRESTY_SAAS_PCRE2_VER).orig.tar.gz openresty-pcre2_$(OPENRESTY_SAAS_PCRE2_VER)
...
openresty-pcre2-build: openresty-pcre2-clean openresty-pcre2-download
	...
	tar xf openresty-pcre2_$(OPENRESTY_SAAS_PCRE2_VER).orig.tar.gz --strip-components=1 -C openresty-pcre2
	cd openresty-pcre2 \
