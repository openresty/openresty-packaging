...
openresty-openssl3-asan-download:
	...
	rm -rf openresty-openssl3-asan_$(SSL3_VER)
	mkdir -p openresty-openssl3-asan_$(SSL3_VER)
	tar -xf openssl-$(SSL3_VER).tar.gz --strip-components=1 -C openresty-openssl3-asan_$(SSL3_VER)
	tar -czf openresty-openssl3-asan_$(SSL3_VER).orig.tar.gz openresty-openssl3-asan_$(SSL3_VER)
...
openresty-openssl3-asan-build: openresty-openssl3-asan-clean openresty-openssl3-asan-download
	...
	tar xf openresty-openssl3-asan_$(SSL3_VER).orig.tar.gz --strip-components=1 -C openresty-openssl3-asan
