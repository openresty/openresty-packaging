...
lua-resty-http-fast-1.21.4-clean:
	...
	-find lua-resty-http-fast-1.21.4 -maxdepth 1 ! -name 'debian' ! -name 'lua-resty-http-fast-1.21.4' -print | xargs rm -rf
	rm -rf lua-resty-http-fast-1.21.4*.deb
	rm -rf lua-resty-http-fast-1.21.4_*.*

#sudo apt-get -y -q install libtemplate-perl debhelper devscripts dh-systemd
#sudo apt-get -y -q install --only-upgrade libtemplate-perl debhelper devscripts dh-systemd
.PHONY: lua-resty-http-fast-1.21.4-build
lua-resty-http-fast-1.21.4-build: lua-resty-http-fast-1.21.4-clean lua-resty-http-fast-1.21.4-download
