...
OPENRESTY_PYTHON3_CYTHON_VER := 0.28.5

.PHONY: openresty-python3-cython-download
openresty-python3-cython-download:
	wget -nH --cut-dirs=100 --mirror 'https://github.com/cython/cython/archive/$(OPENRESTY_PYTHON3_CYTHON_VER)/Cython-$(OPENRESTY_PYTHON3_CYTHON_VER).tar.gz'
	...
	tar -xf Cython-0.28.5.tar.gz --strip-components=1 -C openresty-python3-cython_$(OPENRESTY_PYTHON3_CYTHON_VER)
...
openresty-python3-cython-build: openresty-python3-cython-clean openresty-python3-cython-download
	...
	tar xf openresty-python3-cython_0.28.5.orig.tar.gz --strip-components=1 -C openresty-python3-cython
