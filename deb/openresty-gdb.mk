...
openresty-gdb-download:
	...
	tar -xf gdb-8.3.tar.xz --strip-components=1 -C openresty-gdb_$(OPENRESTY_GDB_VER)
...
openresty-gdb-build: openresty-gdb-clean openresty-gdb-download
	...
	tar xf openresty-gdb_8.3.orig.tar.gz --strip-components=1 -C openresty-gdb
	cd openresty-gdb \
