...
openresty-saas-asan-build: openresty-saas-asan-clean openresty-saas-asan-download
	sudo apt-get -y -q install ccache gcc make perl ccache gcc make perl openresty-zlib-asan-dev openresty-openssl111-asan-dev openresty-pcre-asan-dev libc-dev
	sudo apt-get -y -q install --only-upgrade ccache gcc make perl ccache gcc make perl openresty-zlib-asan-dev openresty-openssl111-asan-dev openresty-pcre-asan-dev libc-dev
