...
openresty-openssl3-download:
	...
	rm -rf openresty-openssl3_$(OPENRESTY_OPENSSL3_VER)
	mkdir -p openresty-openssl3_$(OPENRESTY_OPENSSL3_VER)
	tar -xf openssl-$(OPENRESTY_OPENSSL3_VER).tar.gz --strip-components=1 -C openresty-openssl3_$(OPENRESTY_OPENSSL3_VER)
	tar -czf openresty-openssl3_$(OPENRESTY_OPENSSL3_VER).orig.tar.gz openresty-openssl3_$(OPENRESTY_OPENSSL3_VER)
...
openresty-openssl3-build: openresty-openssl3-clean openresty-openssl3-download
	...
	tar xf openresty-openssl3_$(OPENRESTY_OPENSSL3_VER).orig.tar.gz --strip-components=1 -C openresty-openssl3
