...
ngx-multi-upstream-module-1.25.3-download:
	...
	tar -xf openresty-1.25.3.2.tar.gz -C ngx-multi-upstream-module-1.25.3_$(NGX_MULTI_UPSTREAM_MODULE_VER)
	tar -xf mod_dubbo-$(MOD_DUBBO_VER).tar.gz -C ngx-multi-upstream-module-1.25.3_$(NGX_MULTI_UPSTREAM_MODULE_VER)
