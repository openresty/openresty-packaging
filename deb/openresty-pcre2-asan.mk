...
openresty-pcre2-asan-download:
	...
	rm -rf openresty-pcre2-asan_$(OPENRESTY_PCRE2_VER)
	mkdir -p openresty-pcre2-asan_$(OPENRESTY_PCRE2_VER)
	tar -xf pcre2-$(OPENRESTY_PCRE2_VER).tar.gz --strip-components=1 -C openresty-pcre2-asan_$(OPENRESTY_PCRE2_VER)
	tar -czf openresty-pcre2-asan_$(OPENRESTY_PCRE2_VER).orig.tar.gz openresty-pcre2-asan_$(OPENRESTY_PCRE2_VER)
...
openresty-pcre2-asan-build: openresty-pcre2-asan-clean openresty-pcre2-asan-download
	...
	tar xf openresty-pcre2-asan_$(OPENRESTY_PCRE2_VER).orig.tar.gz --strip-components=1 -C openresty-pcre2-asan
