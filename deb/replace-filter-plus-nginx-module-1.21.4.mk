...
REPLACE_FILTER_PLUS_NGINX_MODULE_VER := 0.0.4
NGX_VER := 1.27.1
OPENRESTY_VER := $(NGX_VER).1

.PHONY: replace-filter-plus-nginx-module-1.27.1-download
replace-filter-plus-nginx-module-1.27.1-download:
...
replace-filter-plus-nginx-module-1.27.1-clean:
...
.PHONY: replace-filter-plus-nginx-module-1.27.1-build
replace-filter-plus-nginx-module-1.27.1-build: replace-filter-plus-nginx-module-1.27.1-clean replace-filter-plus-nginx-module-1.27.1-download
