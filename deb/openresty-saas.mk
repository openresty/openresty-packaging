...
OPENRESTY_SAAS_VER := $(OR_PLUS_VER)
...
openresty-saas-build: openresty-saas-clean openresty-saas-download
	sudo apt-get -y -q install ccache gcc make perl openresty-saas-zlib-dev openresty-plus-openssl111-dev openresty-saas-pcre-dev libgd-dev libc-dev $(deb_toolchain_pkgs)
	sudo apt-get -y -q --only-upgrade install ccache gcc make perl openresty-saas-zlib-dev openresty-plus-openssl111-dev openresty-saas-pcre-dev libgd-dev libc-dev $(deb_toolchain_pkgs)
