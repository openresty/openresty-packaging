...
BuildRequires:  openresty-openssl3-debug-devel >= 3.5.7-1
BuildRequires:  openresty-pcre2-devel >= 10.44-1
BuildRequires:  kernel-headers

Requires:       valgrind
Requires:       openresty-zlib >= 1.2.12-1
Requires:       openresty-openssl3-debug >= 3.5.7-1
Requires:       openresty-pcre2 >= 10.44-1

AutoReqProv:        no

%define orprefix            %{_usr}/local/%{name}
%define openssl_prefix      %{_usr}/local/openresty-debug/openssl3
...
%changelog
* Mon Aug 31 2026 Yichun Zhang (agentzh) 1.31.4.1-1
- upgraded openresty to 1.31.4.1.
* Thu Jun 4 2026 Yichun Zhang (agentzh) 1.31.1.1-1
- upgraded openresty to 1.31.1.1.
* Tue May 26 2026 Yichun Zhang (agentzh) 1.29.2.5-1
- upgraded openresty to 1.29.2.5.
* Fri May 15 2026 Yichun Zhang (agentzh) 1.29.2.4-1
- upgraded openresty to 1.29.2.4.
...
- upgraded openresty to 1.29.2.1.
* Thu Jan 22 2026 Yichun Zhang (agentzh) 1.29.4.3-1
- upgraded openresty to 1.29.4.3.
