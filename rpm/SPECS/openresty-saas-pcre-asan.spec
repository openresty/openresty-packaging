...
%description devel
Development files for Perl-compatible regular expression library for use by OpenResty SaaS ONLY
...
%changelog
* Thu Jun 2 2022 Yichun Zhang (agentzh) 8.45-2
- upgraded PCRE to 8.45.
* Thu Jun 2 2022 Yichun Zhang (agentzh) 8.45-1
- upgraded PCRE to 8.45.
