Name:           coro-hiredis-nginx-module-1.25.3
Version:        0.0.8
Release:        2%{?dist}
...
BuildRequires:  coro-nginx-module-1.25.3-devel >= 0.0.10
BuildRequires:  openresty-hiredis-devel
BuildRequires:  openresty
Requires:       coro-nginx-module-1.25.3 >= 0.0.10
...
./configure \
    ...
    --with-cc-opt="-DNGX_HTTP_CORO_USE_FREE_LISTS -I%{zlib_prefix}/include -I%{pcre_prefix}/include -I%{openssl_prefix}/include -I%{elfutils_prefix}/include -I%{elf_loader_prefix}/include -I%{prefix}/include -I%{hiredis_prefix}/include -O3" \
...
%changelog
* Thu Oct 10 2024 Yichun Zhang (agentzh) 0.0.8-2
- upgraded coro-hiredis-nginx-module to 0.0.8.
* Thu Oct 10 2024 Yichun Zhang (agentzh) 0.0.8-1
- upgraded coro-hiredis-nginx-module to 0.0.8.
...
- upgraded coro-hiredis-nginx-module to 0.0.5.
* Wed Apr 5 2023 Yichun Zhang (agentzh) 0.0.4-1
- upgraded coro-hiredis-nginx-module to 0.0.4.
* Tue Apr 4 2023 Yichun Zhang (agentzh) 0.0.3-1
- upgraded coro-hiredis-nginx-module to 0.0.3.
* Thu Mar 30 2023 Yichun Zhang (agentzh) 0.0.2-1
- upgraded coro-hiredis-nginx-module to 0.0.2.
* Thu Mar 30 2023 Hui Wang 0.0.1-1
- initial build for coro-hiredis-nginx-module.
