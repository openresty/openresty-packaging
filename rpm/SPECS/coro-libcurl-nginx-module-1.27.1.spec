Name:           coro-libcurl-nginx-module-1.27.1
Version:        0.0.8
Release:        1%{?dist}
...
Requires:       openresty-libcurl >= 7.81.0.4-1
...
- upgraded coro-libcurl-nginx-module to 0.0.8.
...
- upgraded coro-libcurl-nginx-module to 0.0.4.
* Mon Oct 7 2024 Yichun Zhang (agentzh) 0.0.3-1
- upgraded coro-libcurl-nginx-module to 0.0.3.
