...
BuildRequires:  openresty-plus-debug
...
Requires:       openresty-plus-debug
Requires:       %{name}-data


%define orprefix                        %{_usr}/local/openresty-plus-debug
...
It is almost the same as lua-resty-ebpf but for openresty-plus-debug package.
