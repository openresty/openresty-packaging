...
Name:       openresty-postgresql16-auto-failover
Version:    2.1
Release:    1%{?dist}
...
AutoReqProv:    no
BuildRequires:  openresty-postgresql16-devel >= 16.5-1, ccache, ncurses-devel, libxml2-devel, libxslt-devel, readline-devel, make, gcc
Requires:       openresty-postgresql16 >= 16.5-1
...
- Initial build for pg_auto_failover on PostgreSQL 16
