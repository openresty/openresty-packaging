...
BuildRequires:  openresty-saas-zlib-devel >= 1.2.11-3
...
%endif
Requires:       openresty-saas-zlib >= 1.2.11-3
...
%endif
    ...
    --with-threads \
    --with-compat  \
    --with-luajit-xcflags='-fPIC -DLUAJIT_NUMMODE=2 -DLUAJIT_ENABLE_LUA52COMPAT -g3 -DLUAJIT_ENABLE_GC64' \
    --with-static-luajit \
    -j`nproc`
...
%changelog
* Mon Dec 2 2024 Yichun Zhang (agentzh) 1.19.9.1.76-1
- upgraded openresty-plus to 1.19.9.1.76.
* Tue Nov 26 2024 Yichun Zhang (agentzh) 1.19.9.1.75-1
- upgraded openresty-plus to 1.19.9.1.75.
* Wed Nov 20 2024 Yichun Zhang (agentzh) 1.19.9.1.74-1
- upgraded openresty-plus to 1.19.9.1.74.
* Wed Nov 13 2024 Yichun Zhang (agentzh) 1.19.9.1.73-1
- upgraded openresty-plus to 1.19.9.1.73.
* Wed Nov 6 2024 Yichun Zhang (agentzh) 1.19.9.1.72-1
- upgraded openresty-plus to 1.19.9.1.72.
* Wed Nov 6 2024 Yichun Zhang (agentzh) 1.19.9.1.71-1
- upgraded openresty-plus to 1.19.9.1.71.
* Fri Oct 11 2024 Yichun Zhang (agentzh) 1.19.9.1.70-1
- upgraded openresty-plus to 1.19.9.1.70.
...
- upgraded openresty-plus to 1.19.9.1.68.
...
* Mon Jul 15 2024 Yichun Zhang (agentzh) 1.19.9.1.64-1
- upgraded openresty-plus to 1.19.9.1.64.
