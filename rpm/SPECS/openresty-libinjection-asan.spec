Name:           openresty-libinjection-asan
Version:        3.10.4
Release:        1%{?dist}
...
export CC='ccache gcc -fsanitize=address -fno-omit-frame-pointer'
export CXX='ccache g++ -fsanitize=address -fno-omit-frame-pointer'
make compile
