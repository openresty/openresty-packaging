...
%if %{with_perf}
%package -n openresty-perf
Summary: Performance monitoring for the Linux kernel
Group: Development/System
License: GPLv2
%description -n openresty-perf
This package contains the perf tool, which enables performance monitoring
of the Linux kernel.

%package -n openresty-perf-debuginfo
Summary: Debug information for package perf
Group: Development/Debug
Requires: %{name}-debuginfo-common-%{_target_cpu} = %{version}-%{release}
AutoReqProv: no
%description -n openresty-perf-debuginfo
...
%package -n openresty-python-perf
Summary: Python bindings for apps which will manipulate perf events
Group: Development/Libraries
%description -n openresty-python-perf
...
%package -n openresty-python-perf-debuginfo
Summary: Debug information for package perf python bindings
Group: Development/Debug
Requires: %{name}-debuginfo-common-%{_target_cpu} = %{version}-%{release}
AutoReqProv: no
%description -n openresty-python-perf-debuginfo
...
%if %{with_tools}
%package -n openresty-kernel-tools
...
%package -n openresty-kernel-tools-libs
Summary: Libraries for the kernels-tools
Group: Development/System
License: GPLv2
%description -n openresty-kernel-tools-libs
This package contains the libraries built from the tools/ directory
from the kernel source.

%package -n openresty-kernel-tools-libs-devel
Summary: Assortment of tools for the Linux kernel
Group: Development/System
License: GPLv2
...
%package -n openresty-kernel-tools-debuginfo
Summary: Debug information for package kernel-tools
Group: Development/Debug
Requires: %{name}-debuginfo-common-%{_target_cpu} = %{version}-%{release}
AutoReqProv: no
%description -n openresty-kernel-tools-debuginfo
...
%if %{with_tools}
%post -n openresty-kernel-tools-libs
/sbin/ldconfig

%postun -n openresty-kernel-tools-libs
/sbin/ldconfig
%endif
...
%if %{with_debuginfo}
%files -f perf-debuginfo.list -n openresty-perf-debuginfo
%defattr(-,root,root)

%files -f python-perf-debuginfo.list -n openresty-python-perf-debuginfo
%defattr(-,root,root)
%endif
%endif # with_perf

%if %{with_tools}
%files -n openresty-kernel-tools -f cpupower.lang
%defattr(-,root,root)
%ifarch %{cpupowerarchs}
%{_bindir}/cpupower
%ifarch %{ix86} x86_64
...
%if %{with_debuginfo}
%files -f kernel-tools-debuginfo.list -n openresty-kernel-tools-debuginfo
%defattr(-,root,root)
%endif

%ifarch %{cpupowerarchs}
%files -n openresty-kernel-tools-libs
%{_libdir}/libcpupower.so.0
%{_libdir}/libcpupower.so.0.0.1

%files -n openresty-kernel-tools-libs-devel
