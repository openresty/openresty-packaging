...
AutoReqProv:    no
BuildRequires:  openresty-postgresql16-devel >= 16.5, openresty-plus-openssl111-devel
Requires:       openresty-postgresql16 >= 16.5, openresty-plus-openssl111
...
- initial build for TimescaleDB on postgresql v16.
