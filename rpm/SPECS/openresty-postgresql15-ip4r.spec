...
AutoReqProv:    no
BuildRequires:  openresty-postgresql15-devel >= 15.9
Requires:       openresty-postgresql15 >= 15.9
...
%changelog
* Mon Nov 18 2024 He Shushen 2.4.2
- initial build for postgresql extension ip4r on postgresql v15.
