Name:           coro-hiredis-nginx-module-1.27.1
Version:        0.0.8
Release:        2%{?dist}
...
BuildRequires:  coro-nginx-module-1.27.1-devel >= 0.0.10
BuildRequires:  openresty-hiredis-devel
BuildRequires:  openresty
Requires:       coro-nginx-module-1.27.1 >= 0.0.10
...
- upgraded openresty-coro-hiredis-nginx-module to 0.0.5.
* Wed Apr 5 2023 Yichun Zhang (agentzh) 0.0.4-1
- upgraded openresty-coro-hiredis-nginx-module to 0.0.4.
* Tue Apr 4 2023 Yichun Zhang (agentzh) 0.0.3-1
- upgraded openresty-coro-hiredis-nginx-module to 0.0.3.
