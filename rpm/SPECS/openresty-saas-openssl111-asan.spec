Name:               openresty-saas-openssl111-asan
Version:            1.1.1t
Release:            1%{?dist}
...
Summary:            Development files for OpenResty SaaS's OpenSSL library
Group:              Development/Libraries
Requires:           %{name} = %{version}-%{release}

%description devel
Provides C header and static library for OpenResty SaaS's OpenSSL library.
...
* Mon Mar 21 2022 Yichun Zhang (agentzh) 1.1.1n-1
- upgraded OpenSSL SaaS to 1.1.1n.
...
- upgraded OpenSSL SaaS to 1.1.1i.
* Thu Aug 27 2020 Jiahao Wang (johnny) 1.1.1g-1
- initial build for OpenSSL SaaS 1.1.1g.
