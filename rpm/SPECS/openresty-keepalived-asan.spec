Name:           openresty-keepalived-asan
Version:        2.2.4
Release:        1%{?dist}
...
Requires: libnl3
Requires: openresty-plus-openssl111-asan >= 1.1.1l
...
%build
./build_setup
CC='ccache gcc -fdiagnostics-color=always -fsanitize=address -fno-omit-frame-pointer' \
