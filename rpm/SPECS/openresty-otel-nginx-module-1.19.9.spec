...
mkdir build
cd build
cmake -DPCRE_ROOT_DIR=%{pcre_prefix} -DNGX_OTEL_NGINX_BUILD_DIR=/usr/local/openresty-plus/build/nginx-1.19.9/objs -DOPENSSL_ROOT_DIR=/usr/local/openresty-plus/openssl111 -DZLIB_ROOT=/opt/openresty-saas/zlib ..
