Name:           openresty-otel-nginx-module-1.19.9
Version:        0.1.1.1
Release:        1%{?dist}
...
mkdir build
cd build
cmake -DNGX_OTEL_NGINX_BUILD_DIR=../openresty-plus-%{or_version}/build/nginx-1.19.9/objs -DOPENSSL_ROOT_DIR=/usr/local/openresty-plus/openssl111 -DZLIB_ROOT=/opt/openresty-saas/zlib -D "CMAKE_C_FLAGS=%{NGX_CC_OPT}" -D "CMAKE_CXX_FLAGS=%{NGX_CC_OPT}" -D "CMAKE_MODULE_LINKER_FLAGS=%{NGX_LD_OPT}" ..
