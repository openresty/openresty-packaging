...
%changelog
* Mon Jan 29 2024 Yichun Zhang (agentzh) 4.9.3.7-1
- upgraded tcpdump-plus to 4.9.3.7.
* Wed Nov 1 2023 Yichun Zhang (agentzh) 4.9.3.6-3
- add dependency libnl3-200 for opensuse.
...
- upgraded tcpdump-plus to 4.9.3.5.
